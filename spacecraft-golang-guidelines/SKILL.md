...
- Release builds: `go build -ldflags="-s -w"`. Per `spacecraft-steelbore-standard` §3.2, note every
  ...
  > See `spacecraft-steelbore-standard` §3.2.1.
