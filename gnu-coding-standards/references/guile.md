...
**Defer language craft to the `guile-functional-concurrent` skill** for idiomatic functional
and concurrent Scheme (fibers, channels, SRFIs, hygienic macros). This file covers only the
GNU-package layer.
