...
**Scope.** The test categories every Steelbore CLI MUST include in its CI
...
Every Steelbore CLI CI pipeline MUST include tests in each of the
...
| 27 | Steelbore palette only in TUI | Screenshot diff against palette reference; no out-of-palette colors | MAJOR |
