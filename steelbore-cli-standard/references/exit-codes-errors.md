...
```json
{
  "error": {
    ...
    "docs_url": "https://steelbore.dev/docs/rate-limits"
  }
}
```
...
- Flush stderr before exit. Buffered writers that drop on exit have caused diagnostic loss in prior Steelbore projects.
